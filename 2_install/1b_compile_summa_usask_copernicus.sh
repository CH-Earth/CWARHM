...
dest_line=$(grep -m 1 "install_path_summa" ../0_controlFiles/control_active.txt) # full settings line
...
exe_line=$(grep -m 1 "exe_name_summa" ../0_controlFiles/control_active.txt) 
