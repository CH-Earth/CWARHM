...
dest_line=$(grep -m 1 "parameter_land_vrt4_path" ../../../0_controlFiles/control_active.txt) # full settings line
...
dest_line=$(grep -m 1 "parameter_land_tif_path" ../../../0_controlFiles/control_active.txt) # full settings line
